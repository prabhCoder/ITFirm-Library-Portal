...
public class UserReport {
	    ...
	    File exactFile;
	    {
	        ...
	        firstSheet = workbook.createSheet("USER DOWNLOAD REPORT");
	   ...
	   /* public static void main(String args[]) throws Exception {
	    ...
	    public void createEX(OutputStream out){
	        ...
	        Userfunctions book = new Userfunctions();
	        String cid1 = getCID(); 
	       
	        ResultSet rs =book.display_books(cid1);
	       ...
	       try{
	        ...
	        UserReport ur = new UserReport(recordToAdd);
	        ur.createFile(out);
	       }catch(Exception e){
	    	   e.printStackTrace();
	       }
	    ...
	    void createFile(OutputStream out){
	     ...
	     UserReport(List<List> l1) throws Exception {
	        try {
