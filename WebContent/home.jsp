  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><a href="User/display_gallery.jsp"><img src="images/index_07.gif" alt="" width="108" height="57" border="0"></a></td>
        ...
        <td width="70%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right"><p>&nbsp;</p>
              ...
              <tr>
                <td><img src="images/index_14.gif" width="343" height="33" alt=""></td>
              </tr>
              <tr>
                        </tr>		
            </table></td>
            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/index_24.gif">
              <tr>
                <td width="68%" align="right"><table width="89%" border="0" cellspacing="10" cellpadding="0">
                  <tr>
                    <td class="white-text"><strong></strong><br>
                        The library services have been automated with the software. It is a menu driven, interactive, user-friendly package, designed with utmost care to meet the students information needs, such as the availability of books, status of the books, user details etc.</td>
                  </tr>
                  <tr>
                   
                  </tr>
                </table></td>
                <td width="32%" align="right"><img src="images/index_25.jpg" width="224" height="187" alt=""></td>
              </tr>
            </table></td>
          </tr>
          <tr>
