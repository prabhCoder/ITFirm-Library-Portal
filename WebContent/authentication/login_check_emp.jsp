            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/index_24.gif">
              <tr>
                <td width="68%" align="right"><table width="89%" border="0" cellspacing="10" cellpadding="0">
                  <tr>
                  <%
              	String s1=request.getParameter("libloginid");
            		HttpSession session1=request.getSession(true);
            		session1.setAttribute("loginid", s1);
            		String s2=request.getParameter("libpassword");
            		String id=null;
            		
            				String msg=null;
            		Authentication auth=new Authentication();
            			//response.sendRedirect("displayhome.jsp");
            		
            		msg=auth.authentication_emp(s1,s2);
            		if (msg.equals("success"))
            		{	
            		 
            		 session1.setAttribute("libloginid", s1);
            			RequestDispatcher rd=request.getRequestDispatcher("display_emp.jsp");
            		...
            		out.println("<h1><a href='login.jsp'>Login again</a></h1>");
            		}
