            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/index_24.gif">
              <tr>
                <td width="68%" align="right"><table width="89%" border="0" cellspacing="10" cellpadding="0">
                  ...
                  ResultSet rs=afunc.send_password_employee(id);
                  String pass=null;
                  String mail=null;
                  while(rs.next())
                  {
                      ...
                      String subject = "Hi this is test Mail";  
           	        String messageBody = ("Your password is: "+pass);  
           	  
           	        new SendEmail().sendMail(mail, subject, messageBody);
           	       
           	       out.print("<h2><br/>check mail!! Password has been sent to you!!</h2>");
                  }
