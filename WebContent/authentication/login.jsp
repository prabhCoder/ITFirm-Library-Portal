            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/index_24.gif">
              <tr>
                <td width="68%" align="right"><table width="89%" border="0" cellspacing="10" cellpadding="0">
                  <tr>
                  <TD>
<form action="Login_check_user.jsp" method="get">
<h3>USER LOGIN</h3>

Username<input type="text"  name="loginid" value="Enter loginid" onfocus="if (this.value == 'Enter loginid') {this.value = '';}"/><br/><br/>
Password<input type="password" name="cpassword" value="Enter password" onfocus="if (this.value == 'Enter password') {this.value = '';}"/><br/>
<input type="submit" value="SUBMIT" /><br/>

<a href=../User/Register_customer.jsp>Register if not a member!!</a><br/>
<a href="forget_password_customer.jsp">Forget password?</a>
  ...
  <TD>
<form action="login_check_emp.jsp" method="get">
<h3>EMPLOYEE LOGIN</h3>

Employeename<input type="text"  name="libloginid" value="Enter loginid" onfocus="if (this.value == 'Enter loginid') {this.value = '';}"/><br/><br/>
Password<br/><input type="password" name="libpassword" value="Enter password" onfocus="if (this.value == 'Enter password') {this.value = '';}"/><br/>
<input type="submit" value="SUBMIT" /><br/>

<a href="../Admin/Register_employee.jsp">Register if not a member!!</a><br/>
<a href="forget_password_employee.jsp">Forget password?</a>
...
A library is a delivery room for the birth of ideas, a place where history comes to life.<br/> We provide the options of issuing/returning/reservation a book to a member only</span></td>
        ...
        <td width="30%" align="right" valign="top"><p>&nbsp;</p>
         ...
         <a href="login.jsp"> LOGIN </a> to be a member of this library!!<br/>
