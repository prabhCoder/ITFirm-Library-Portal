...
<%@page import="org.apache.taglibs.standard.lang.jpath.expression.UserFunction"%>
          ...
          <tr>
            ...
            out.println("<a href=Books_in_account.jsp><h3>View books issued to you</h3></a>");
             ...
             %>
          		...
          		ResultSet rs=rf.returndate_remind(s1, s);
          		String isue=null;
          		String retrn=null;
          		...
          		try {
          			while(rs.next())
          			{
          				...
          				retrn=rs.getString(3);
          				
          				
          				flag=rs.getString(6);
          			}
          			
          		if(date.compareTo(retrn)<0)
          		{
          			if(flag.equals("no"))
          			{
          			
          					System.out.println("today: "+date+", return: "+retrn);
          					System.out.println("book can be reisued");
          					String idate=uf.issuedate();
          					 rdate=uf.duedate();
          				//	uf.delete_rec(s1,s,isue,retrn);
          					// count=0;
          					
          					String flag1="yes";
          				//	boolean b=uf.reissue_entry_reissuetable(s1,s,idate,rdate,count);
          					boolean b=uf.reissue_entry_issuetable(s1,s,idate,rdate,flag1);
          								
          					if(b)
          					{
          						
          						out.print("Book id "+s1+"is reissued till "+rdate);	
          			...
          			else if(flag.equals("yes"))
          			{
          				...
          				out.print("<h2>Book is already reissued once!!</h2>");
          		...
          		{
          			out.print("<h2>Book cannot be reissued after duedate!!</h2>");
          		}
