          ...
          <tr>
           <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/index_24.gif">
              <tr>
        		...
        		String s2=request.getParameter("bookauthor");
        		String s3=request.getParameter("Select Booktype");
        		String s4=request.getParameter("Select location");
        		...
        		AdminFunctions afunc=new AdminFunctions();
        	ResultSet rs=afunc.search(s1,s2,s3,s4);
          ...
          <tr>
                          ...
                          <td bgcolor="orange"><h3>PRICE</h3></td>
                           <td bgcolor="orange"><h3>STATUS</h3></td>
                            <td bgcolor="orange"><h3>LOCATION</h3></td>
                              <td bgcolor="orange"><h3>ISSUE</h3></td>     
                  </tr> 
            ...
            <TR>
                ...
                <TD> <%= rs.getString(9) %></TD>
                 ...
                 <TD>   <%String isbn1=null;
            isbn1=rs.getString(1); 
            if(name!=null)
          	{
            out.print("<a href=Issue.jsp?isbn="+isbn1+">Issue</a>");
          	}
            %>
