<%@page import="org.apache.jk.core.Msg"%>
          ...
          <tr>
            <td align="right"><p>&nbsp;</p>
              ...
              <tr>
            		...
            		String s2=request.getParameter("custaddress");
            		String s3=request.getParameter("custcontact");
            		String s4=request.getParameter("custmail");
            		String s5=request.getParameter("loginid");
            		String s6=request.getParameter("cpassword");
            		String s7=request.getParameter("cdob");
            		
            		
            		 
                    
                     Authentication authenticate=new Authentication();
                     String msg=authenticate.compare_loginid(s5);
                     if(msg.equals("invalid"))
                     {
                      out.print("Loginid already exist");
                      out.print("<br/>");
                      out.print("<a href='Register_customer.jsp'>Go back</a>");
                     }
                     else
                     {
            		Userfunctions userfunc = new Userfunctions();
            		userfunc.insert_customer_record(s1,s2,s3,s4,s5,s6,s7);
            		
            		out.print("Registered!!!");
            		out.print("<br/>");
            		out.print("<a href='../authentication/login.jsp'>LOGIN</a>");
            		}
                  %>
