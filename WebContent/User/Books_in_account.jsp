            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/index_24.gif">
              <tr>
                <td width="68%" align="right"><table width="89%" border="0" cellspacing="10" cellpadding="0">
          		...
          		String cid=(String)session1.getAttribute("cid");
          		//String s1=(String)session.getAttribute("isbn");
          		Userfunctions func=new Userfunctions();
          		
          		out.print("<h1><u>Book issued to you</u></h1>");
          		Authentication auth=new Authentication();
             	String name=auth.return_name(cid);
                ...
                out.println("<a href=Books_in_account.jsp><h3>View books issued to you</h3></a>");
                  ...
                  <tr>
                     ...
                     <a href=DownloadUserReport>Download User History</a>
                  </tr>
                </table></td>
          ...
          <tr>
            <td align="right"><p>&nbsp;</p>
              ...
              <tr>
                ...
                <td><table width="100%" border="10" bordercolor="orange" cellspacing="10" cellpadding="0">
                  <tr>
                      <td bgcolor="ORANGE "><H3>ISBN</H3></td>
                      <td bgcolor="orange"><h3>ISSUEDATE</h3></td>
                      <td bgcolor="orange"><h3>RETURNDATE</h3></td>
                       <td bgcolor="orange"><h3>RETURN</h3></td>
                        <td bgcolor="orange"><h3>REISSUE</h3></td>     
                  </tr> 
                  <tr>
                   <td>
                   <%
                   String isbn=null;
                   ResultSet rs=func.display_books(cid);
                   while(rs.next())
                   {
                   ...
                   <td>
                    <%
                    ResultSet rs1=func.display_books(cid);
                   while(rs1.next())
                   {
                   ...
                   <td>
                    <%
                    ResultSet rs2=func.display_books(cid);
                   while(rs2.next())
                   {
                   ...
                   <td>
                     <%
                          out.println("<a href=Return.jsp?isbn="+isbn+">Return</a>");
                   %>
                 
                    </td>
                    <td>
                    <%
                       out.println("<a href=Reissue.jsp?isbn="+isbn+">Reissue</a>");
                    %>
                       </td>
                    </tr>
                </table></td>
