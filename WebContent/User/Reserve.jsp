<%@page import="in.co.init.OLM.admin.Reminder"%>
        ...
        <td width="70%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            out.println("<a href=Books_in_account.jsp><h3>View books issued to you</h3></a>");
          		...
          		boolean b=uf.reserve(s1, s);
          	if(b)
          	{
          		
          		out.print("<h2>Bookid :"+s1+" has been reserved!!"+"<br/>"+" Mail will be sent to you when the book will be available..then you can issue it!!</h2>");
            ...
            String bookname=null;
		        String author=null;
		        ResultSet rs=func.bookdetails(s1);
		        while(rs.next())
		        {
          ...
          while (rs1.next()) {
              ...
              String subject = "Hi this is test Mail";  
   	        String messageBody = "Test Mail from online library management!! Book id "+s1+" , "+bookname+" of author "+author+" has been reserved!!";  
