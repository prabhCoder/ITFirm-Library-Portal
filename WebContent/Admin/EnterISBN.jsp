          ...
          <tr>
            <td align="right"><p>&nbsp;</p>
              ...
              <tr>
                    ...
                    <h2 style="color: orange" align="center"><u>View History of a book</u></h2>
                <form action="view_bookhistory.jsp" method="get" onsubmit="return isbnvalidation();">
                <input type="text" name="isbn" id="isbn" value="Enter BookISBN" onfocus="if (this.value == 'Enter BookISBN') {this.value = '';}" /><br/><br/>
