          ...
          <tr>
           <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/index_24.gif">
         	...
         	String name=auth.return_name_emp(s);
          	...
          	session1.setAttribute("isbn1",isbn);
          	ResultSet rs=func.displaybooks_history(isbn);
          	String sendisbn = null;
          
     
             %>
                          </tr>
                  <tr>
                  <a href="DownloadIssueBookHistory"?isbn=<%= isbn %> >Download Issue History</a>
                  </tr>
                </table></td>
