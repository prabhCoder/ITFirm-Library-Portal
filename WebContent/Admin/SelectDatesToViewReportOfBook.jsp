...
if(fromdate=="" || todate=="")
	{
alert("Please enter Fromdate/Todate");
    ...
    <td class="bg1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="right"><p>&nbsp;</p>
              ...
              <tr>
                  ...
                  <form action="view_bookreport.jsp" method="get" onsubmit="return checkdates();">
                  Fromdate	<input type="Text" id="datepicker1" name="datepicker1"/> 
                  Todate<input type="Text" id="datepicker2" name="datepicker2" />
      ...
      <%
            		...
            		if(name!=null)
               	{
            		...
            		{
            			  out.println("<a href='../authentication/login.jsp'> LOGIN </a> to be a member of this library!!");
            		}
             %>   
              <p>&nbsp;</p></td>
          </tr>
