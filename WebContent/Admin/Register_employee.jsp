...
<head>
<title>12</title>
<script src="Register_employee_validation.js"></script>
            ...
            <td align="right"><p>&nbsp;</p>
              ...
              <tr>
                    ...
                    <table width="100%" border="10" bordercolor="orange" cellspacing="10" cellpadding="0">
                     <form name="Register_employee"  method="get" action="Register_done_employee.jsp" onSubmit="return formValidation();">
                      ...
                      <td bgcolor="orange"><h3>CONTACT</h3></td>
                       ...
                       <td bgcolor="orange"><h3>EMAIL-ID</h3></td>
                        ...
                        <tr>
                          ...
                          <td bgcolor="orange"><h3>DATE OF BIRTH</h3></td>
