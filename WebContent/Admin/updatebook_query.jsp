          ...
          <tr>
            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/index_24.gif">
         	...
         	String name=auth.return_name_emp(s);
          	   ...
          	   String isbn=(String)session1.getAttribute("isbn");
          //	String isbn=request.getParameter("isbn");
          	//out.print("isbn is:"+isbn);
                 ...
                 // String s1=request.getParameter("isbn");
                  ...
                  String s6=request.getParameter("price");
                  String s7=request.getParameter("status");
                  String s8=request.getParameter("location");
                
                boolean b=func.update_book(s1,s2,s3,s4,s5,s6,s7,s8,isbn);
                   
              if(b)
              {
                	 out.print("<h2>Record Updated!!!</h2>");
              }   
